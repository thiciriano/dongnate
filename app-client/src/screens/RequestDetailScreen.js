...
export async function RequestDetailScreen(container, params) {
  ...
  try {
    ...
    const alreadyInterested = user && interests.some((int) => int.user_id === user.id);
                    ...
                    <div class="pt-4">
                        ...
                        `
                            ...
                            <div class="bg-dn-green-pale/30 p-8 rounded-[2.5rem] border border-dn-green-pale text-center">
                                ...
                                <a href="/my-requests" data-link class="btn-primary inline-block">GERENCIAR INTERESSADOS</a>
                            </div>
                        `
                        }
                    </div>
    ...
    if (photoUpload) {
        photoUpload.addEventListener("change", async (e) => {
            ...
            try {
                photoPreview.innerHTML = '<div class="animate-spin rounded-full h-6 w-6 border-b-2 border-dn-green"></div>';
