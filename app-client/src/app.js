...
async function router() {
    ...
    if (!user) {
        ...
        else if (!['/login', '/register', '/landing', '/terms', '/privacy', '/how-it-works', '/about'].includes(path)) {
    ...
    const showNav = user && !['/login', '/register', '/register-ong'].includes(targetPath);
    const isFullPage = ['/landing', '/login', '/register', '/register-ong', '/success'].includes(targetPath);
